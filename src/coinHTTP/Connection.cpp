...
Connection::Connection(io_service& io_service, ConnectionManager& manager, RequestHandler& handler) : _ctx(io_service, ssl::context::sslv23), _socket(io_service), _ssl_socket(io_service, _ctx), _secure(false), _connectionManager(manager), _requestHandler(handler) {
}

Connection::Connection(io_service& io_service, ssl::context& context, ConnectionManager& manager, RequestHandler& handler) : _ctx(io_service, ssl::context::sslv23), _socket(io_service), _ssl_socket(io_service, context), _secure(true), _connectionManager(manager), _requestHandler(handler) {
}
